...
public class RunDouble {
    ...
    public static void main() throws IOException, InterruptedException {
        ...
        try {
            ...
            String alfabeto;
            Trie<Double> minhaTrie;

            alfabeto = LerArquivo.ler("alfabeto.txt")[0];
            minhaTrie = new Trie<>(alfabeto);

            String[] dados = LerArquivo.ler("dadosDouble.txt");

            if (dados != null) {

                for (String dado : dados) {
                    String[] info = dado.split(";");
                    minhaTrie.inserir(info[0], Double.parseDouble(info[1]));
                }
            }
    ...
    public static void inserir(Trie<Double> trie) throws IOException, InterruptedException {
        limpaTela();
        Scanner tc = new Scanner(System.in);
        String chave;
        Double valor = null;
    ...
    public static void buscar(Trie<Double> trie) throws IOException, InterruptedException {
        limpaTela();
        Scanner tc = new Scanner(System.in);
        Double v = null;
        String chave;
    ...
    public static void excluir(Trie<Double> trie) throws IOException, InterruptedException {
        limpaTela();
        Scanner tc = new Scanner(System.in);
        String chave;
    ...
    public static void imprimir(Trie<Double> trie) {
        trie.imprimir();
        Scanner tc = new Scanner(System.in);
        mensagemVoltaParaMenu();
        tc.nextLine();
